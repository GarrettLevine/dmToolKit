...
**********************************************/
//FIRSTNAME DATABASE
export const fnBeginning = ["", "", "", "", "", "A", "Be", "De", "El", "Fa", "Jo", "Ki", "La", "Ma", "Na", "O", "Pa", "Re", "Si", "Ta", "Va"];
export const fnMiddle = ["bar", "ched", "dell", "far", "gran", "hal", "jen", "kel", "lim", "mor", "net", "penn", "quil", "rond", "sark", "shen", "tur", "vash", "yor", "zen"];
export const fnEnd = ["", "", "", "a", "ac", "ai", "al", "am", "an", "ar", "ea", "el", "er", "ess", "ett", "ic", "id", "il", "in", "is", "or", "us"];

//LASTNAME DATABASE
export const lnBeginning = ["", "", "", "", "", "Bin", "Bell", "Oz", "Har", "De", "Hu", "Da", "Bre", "Mack", "Me", "Te", "Ka", "Ri", "Lie", "Do", "sla"];
export const lnMiddle = ["ford", "iveau", "iebe", "olos", "men", "in", "jam", "shie", "thi", "ves", "nah", "rah", "hut", "hur", "sla", "nov"];
export const lnEnd = ["", "", "", "man", "ls", "ek", "ick", "mine", "se", "ard", "sley", "ahue", "rah", "eton", "ek", "ovsky", "e"];

//RACE DATABASE
export const npcRace = ["Human", "Orc", "Half-Elf", "Elf", "Dwarf", "Halfling", "Gnome", "Dragonborn", "Tiefling"];

//APEARANCE DATABASE
export const npcFeature = ["wears distinctive jewelery", "has piercings", "wears flamboyant or outlandish clothes", "wears formal, clean clothes", "wears ragged, dirty clothes", "pronounced scar", "missing teeth", "unusual eye colour(or two different colours)", "has tattoos", "has a birthmark", "has unusual skin colour", "is bald", "has braided beard or hair", "has unusual hair color", "has a nervous twitch", "has a distinctive nose", "has a distinctive posture", "is expetionally beautiful", "is expetionally Ugly"];

///ABILITIES DATABASE
export const highAbilityObj = {
...
//BOND DATABASE
export const npcBonds = ["dedicated to fulfilling a personal life goal", "protective of close family members", "protective of colleagues or compatriots", "loyal to a benefactor", "loyal to a patron", "loyal to an employer", "captivated by a romantic interest", "drawn to a special place", "protective of a sentimental keepsake", "protective of a valuable posession", "out for revenge"];

//FLAW DATABASE
export const npcFlawSecret = ["forbidden love", "susceptibility to romance", "enjoys decadence", "arrogant", "envies another person's possesion", "envies another person's station", "overpowering greed", "prone to rage", "has a powerful enemy", "arachnaphobic", "xenophobic", "a biggot", "shamful secret", "scanadalous secret", "secret crime", "secret misdeed", "posession of forbidden lore", "foolhardy bravery"];
